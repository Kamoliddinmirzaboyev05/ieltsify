...
const WritingPage: React.FC = () => {
  ...
  const loadTasks = async () => {
    const tasks = await writingTaskManager.getAll();
    setTasks(tasks);
  };
  ...
  if (selectedTaskId) {
    return (
      <WritingSimulator taskId={selectedTaskId} onBack={handleBackToList} />
    );
  }
  ...
  return (
    <div style={{ paddingBottom: "40px" }}>
      ...
      >
        ...
        >
          💡 Full IELTS Writing Test: Task 1 (20 min, 150+ words) + Task 2 (40
          min, 250+ words) = 60 minutes total
        </Text>
      </div>
      ...
      >
        <Row gutter={[24, 16]} align="middle">
          <Col xs={24} md={16}>
            ...
            >
              Practice with the exact same interface used in official IELTS
              computer-delivered tests. Features include: split-screen layout,
              countdown timer, auto-save, and word counter.
            </Paragraph>
          </Col>
          <Col
            xs={24}
      ...
      {filteredTasks.length === 0 ? (
        ...
        >
          ...
          <Button
            ...
            icon={<Plus size={20} />}
            onClick={() =>
              (window.location.href = "/dashboard/writing-manager")
            }
            style={{
              marginTop: "24px",
              borderRadius: "12px",
            ...
            <Col xs={24} sm={12} lg={8} key={task.id}>
              ...
              >
                ...
                >
                  Task 1:{" "}
                  {task.task1Question
                    ? task.task1Question.substring(0, 80)
                    : "No description"}
                  ...
                </Paragraph>
      ...
      >
        ...
        >
          <li style={{ marginBottom: "8px" }}>
            Full Test: Task 1 (150+ words) + Task 2 (250+ words)
          </li>
          <li style={{ marginBottom: "8px" }}>
            Total time: 60 minutes (20 min Task 1, 40 min Task 2)
          </li>
          <li style={{ marginBottom: "8px" }}>
