    ...
    <ConfigProvider
      theme={{
        ...
        token: {
          ...
          colorBgBase: isDark ? "#0e1626" : "#ffffff",
          colorTextBase: isDark ? "#ffffff" : "#1f2937",
          colorBgContainer: isDark ? "#151f30" : "#ffffff",
          colorBorder: isDark ? "#273750" : "#e5e7eb",
        },
        components: {
          Layout: {
            bodyBg: isDark ? "#0e1626" : "#f8fafc",
            headerBg: isDark ? "#0e1626" : "#ffffff",
            siderBg: isDark ? "#0e1626" : "#ffffff",
          },
          Card: {
            borderRadiusLG: 8,
            colorBgContainer: isDark ? "#151f30" : "#ffffff",
            colorBorderSecondary: isDark ? "#273750" : "#e5e7eb",
          },
          Menu: {
            darkItemBg: "#0e1626",
          ...
          Breadcrumb: {
            ...
            separatorColor: isDark ? "#324563" : "#cbd5e1",
          },
          Input: {
            colorBgContainer: isDark ? "#0e1626" : "#ffffff",
            colorBorder: isDark ? "#273750" : "#d1d5db",
          ...
          Modal: {
            contentBg: isDark ? "#151f30" : "#ffffff",
            headerBg: isDark ? "#151f30" : "#ffffff",
          },
        },
      }}
    >
