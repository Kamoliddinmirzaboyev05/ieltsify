    ...
    <ConfigProvider
      theme={{
        ...
        token: {
          ...
          colorBgBase: isDark ? "#0b1d3a" : "#ffffff",
          colorTextBase: isDark ? "#ffffff" : "#1f2937",
          colorBgContainer: isDark ? "#102a4f" : "#ffffff",
          colorBorder: isDark ? "#16365f" : "#e5e7eb",
        },
        components: {
          Layout: {
            bodyBg: isDark ? "#0b1d3a" : "#f8fafc",
            headerBg: isDark ? "#0b1d3a" : "#ffffff",
            siderBg: isDark ? "#0b1d3a" : "#ffffff",
          },
          Card: {
            borderRadiusLG: 8,
            colorBgContainer: isDark ? "#102a4f" : "#ffffff",
            colorBorderSecondary: isDark ? "#16365f" : "#e5e7eb",
          },
          Menu: {
            darkItemBg: "#0b1d3a",
            darkItemSelectedBg: "rgba(240, 180, 41, 0.1)",
            darkItemHoverBg: "rgba(240, 180, 41, 0.05)",
            darkItemColor: "#94a3b8",
            darkItemSelectedColor: "#f0b429",
            darkItemHoverColor: "#f0b429",
            itemBg: isDark ? "#0b1d3a" : "#ffffff",
            itemSelectedBg: "rgba(240, 180, 41, 0.1)",
            itemHoverBg: "rgba(240, 180, 41, 0.05)",
          ...
          Breadcrumb: {
            ...
            linkHoverColor: "#f0b429",
            separatorColor: isDark ? "#20416c" : "#cbd5e1",
          },
          Input: {
            colorBgContainer: isDark ? "#0b1d3a" : "#ffffff",
            colorBorder: isDark ? "#16365f" : "#d1d5db",
          ...
          Modal: {
            contentBg: isDark ? "#102a4f" : "#ffffff",
            headerBg: isDark ? "#102a4f" : "#ffffff",
          },
        },
      }}
    >
